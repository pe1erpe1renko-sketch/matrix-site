...
export const PLAN_COPY = {
  free: {
    lead: 'По одному вопросу в каждой сфере, чтобы посмотреть, как это работает.',
    items: ['15 вопросов из 92', 'Аркан дня на сегодня'],
  },
  once: {
    lead: 'Одна дата целиком: все двенадцать сфер, девяносто два вопроса и все десять типов разбора по ней.',
    items: [
      'Все 92 вопроса вместо пятнадцати',
      'Деньги, карма, здоровье, род, предназначение — по этой же дате',
      'Совместимость и бизнес по паре с этой датой',
  ...
  circle: {
    ...
    items: [
      '5 дат целиком, каждая со всеми типами разбора',
